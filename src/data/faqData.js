const faqData = [
    ...
    },
    {
        ...
        answer: 'TLE - Time Limit Exceeded - is a very common term used in Competitive Programming, and refers to the condition of your code not being efficient enough, in terms of execution time. It highlights the importance of not just being correct, but being so in an efficient manner.'
    },
    {
        id: 3,
        question: 'What is Competitive Programming?',
        answer: 'Competitive programming is a mind sport usually held over the Internet or a local network, involving participants trying to program according to provided specifications.'
    },
    {
        id: 4,

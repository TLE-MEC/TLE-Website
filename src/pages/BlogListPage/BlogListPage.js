        ...
        <div className='card'>
          ...
          <div className='content' >
            <div className='dsa_icons'>
              ...
              <div className='icons'>
                <div className='icon'><BsClock /> 2 min read</div>
                <div className='icon'><FaPenNib /> 208 words </div>
                <div className='icon'><SlEye /> 15 Views</div>
                <div className='icon'><BiLike />25 Likes</div>
              </div>
            </div>

      ...
      <div className='contentbox'>
        <div className='sidebox'>
          ...
          <div className='topics'>
            <div className="topic">
              <h4><a href="#topic1">Topic 1 -{'>'} beginning </a></h4>
            </div>
            <div className="topic">
              <h4><a href="#topic2">Topic 2</a></h4>
            </div>
            <div className="topic">
              <h4><a href="#topic3">Topic 3</a></h4>
            </div>
          </div>
        </div>
        <div className='mainbox'>
          ...
          <div className='content'>
            <p className='para_content'>
              ...
              Diam aliquam sit pellentesque odio venenatis nisl matti
            </p><br/>
            <h4 id="topic1">Topic 1 - beginning</h4><br/>
            <img src={blogimg} alt="" className='blogimg'/>
            <p className='para_content'><br/>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
              Facilisis hendrerit proin mattis fusce. Adipiscing integer ornare id nisl elit, elit. 
              Diam aliquam sit pellentesque odio venenatis nisl matti
            </p><br/>
        ...
        <img src={blogPage_ellipse3} alt="" className="blogPage_third_ellipse" />         
      </div>
    </div>
